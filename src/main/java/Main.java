					...
					if (check == false) { // if account not found in system
						...
						do {
							...
							if (ch2 == 1) { // printing back statement
								...
								if (SavingsList.get(count).ZakaathCheck()) {
									double zakath = SavingsList.get(count).CalculateZakaath();
									System.out.println("zakath = " + zakath);
								} else {
									System.out.println("you have to less balance too calculate zakath");
								}
							}
